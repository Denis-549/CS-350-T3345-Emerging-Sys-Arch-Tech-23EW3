...
const PWM_Config PWM_config[CONFIG_PWM_COUNT] = {
    /* CONFIG_LED_0_PWM */
    {
        ...
        .object = &pwmTimerCC32XXObjects[CONFIG_LED_0_PWM],
        .hwAttrs = &pwmTimerCC32XXHWAttrs[CONFIG_LED_0_PWM]
    },
};

const uint_least8_t CONFIG_LED_0_PWM_CONST = CONFIG_LED_0_PWM;
